...
ActiveRecord::Schema.define(version: 20161110052418) do
  ...
  add_index "user_artifacts", ["artifact_id"], name: "index_user_artifacts_on_artifact_id"
  add_index "user_artifacts", ["user_id"], name: "index_user_artifacts_on_user_id"
